...
#define rotate_cw 12              // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 10             // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
